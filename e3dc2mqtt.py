...
while True:
  ...
  influxInline += f"pv_power={pv_power}i"
  influxInline += f",home_usage={home_usage}i"
  influxInline += f",grid_power={grid_power}i"
  influxInline += f",battery_power={battery_power}i"
  influxInline += f",grid_feed_power={grid_feed_power}i"
  influxInline += f",grid_usage_power={grid_usage_power}i"
  influxInline += f",battery_feed_power={battery_feed_power}i"
  influxInline += f",battery_usage_power={battery_usage_power}i"
  influxInline += f",battery_soc={battery_soc}i"
